  ...
  return (
    <div className=" container d-flex gap-3 flex-wrap justify-content-center my-5 ">
      <Card className="px-1 py-5 shadow w-card">
        <BsHeartPulseFill size={30} className="text-maincolor ms-4" />
        <Card.Body>
      ...
      <Card className="px-1 py-5 shadow w-card ">
        <FaCapsules size={30} className="text-maincolor ms-4" />
        <Card.Body>
      ...
      <Card className="px-1 py-5 shadow w-card ">
        <BiSolidInjection size={30} className="text-maincolor ms-4" />
        <Card.Body>
      ...
      <Card className="px-1 py-5 shadow w-card ">
        <FaDna size={30} className="text-maincolor ms-4" />
        <Card.Body>
